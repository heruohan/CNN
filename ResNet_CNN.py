# -*- coding: utf-8 -*-
"""
Created on Mon Jul 16 23:04:43 2018

@author: hecongcong
"""

############用tensorflow实现ResNet V2网络.
...
##############创建ResNet通用的arg_scope:用来定义某些函数的参数默认值.
