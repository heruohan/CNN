# -*- coding: utf-8 -*-
"""
Created on Wed Jul 11 23:33:14 2018
...
########定义函数inception_v3_arg_scope,用来生成网络中经常用到
###的函数的默认参数.
...
#########定义函数inception_v3_base,以生成InceptIon V3网络的卷积部分.
def inception_v3_base(inputs,scope=None):
    end_points={}
    with tf.variable_scope(scope,'InceptionV3',[inputs]):
        with slim.arg_scope([slim.conv2d,slim.max_pool2d,\
                             slim.avg_pool2d],stride=1,\
                             padding='VALID'):
            ...
            net=slim.conv2d(net,64,[3,3],padding='SAME',\
                            scope='Conv2d_2b_3x3')
            net=slim.max_pool2d(net,[3,3],stride=2,scope=\
                                'MaxPool_3a_3x3')
        ...
        ########第一个Inception模块组的第一个Inception Module.
        ####名称为：Mixed_5b.
        with slim.arg_scope([slim.conv2d,slim.max_pool2d,\
                             slim.avg_pool2d],stride=1,\
                              padding='SAME'):
            ...
            ####定义第1个Inception模块组的第2个Inception Module,
            ###为：Mixed_5c.
            ...
            ####定义第1个Inception模块组的第3个Inception Module,
            ###为：Mixed_5d.
            ...
            #####第2个Inception模块组的第1个Inception Module,
            ###名称为：Mixed_6a.
            ...
            ######第2个Inception模块组的第2个Incepton Modlue,
            ###名称为：Mixed_6b.
            ...
            #####第2个Inception模块组的第3个Inception Module,
            ###名称为：Mixed_6c.
            ...
            #####第2个Inception模块组的第4个Inception Module,
            ###名称为：Mixed_6d.
            ...
            #####第2个Inception模块组的第5个Inception Module,
            ###名称为：Mixed_6e.
            ...
            #####第3个Inception模块组的第1个Inception Module,
            ###名称为：Mixed_7a.
            ...
            #####第3个Inception模块组的第2个Inception Module,
            ###名称为：Mixed_7b.
            ...
            #####第3个Inception模块组的第3个Inception Module,
            ###名称为：Mixed_7c.
...
############实现Inception V3网络的最后一部分：全局平均池化，softmax和
####Auxiliary.
def inception_v3(inputs,\
    ...
    with tf.variable_scope(scope,'InceptionV3',[inputs,num_classes],\
        ...
        with slim.arg_scope([slim.batch_norm,slim.dropout],\
            ...
            #####处理Auxiliary Logits的逻辑.即为：辅助分类节点.
            with slim.arg_scope([slim.conv2d,slim.max_pool2d,\
                                 slim.avg_pool2d],\
...
sess.run(init)
'''
time_tensorflow_run(sess,logits,info_string='Forward')
